Create one horizontal animation strip for Codex pet `reef`, state `review`.
...
State action: Horizon-review loop: Reef raises one compact closed brass spyglass to one eye, scans slowly from near-right toward near-left with a focused squint and restrained head turn, pauses, then lowers it slightly. The spyglass remains touching one hand and his face or chest in every frame and never floats separately.
