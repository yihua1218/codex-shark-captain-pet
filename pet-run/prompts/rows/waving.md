Create one horizontal animation strip for Codex pet `reef`, state `waving`.
...
State action: Friendly sailor greeting loop: Reef raises one hand into a crisp captain's salute at the brim of his white cap, opens it into a warm wave, then returns to the salute and rest. The other hand stays at his hip. No wave marks and no handheld props.
